      ...
      <div className='bibliography-center-col'>
        ...
        <div className='about-section-container' style={{ display: showAboutSection ? 'block' : 'none' }}>
          <span className='about-section-text'>
            <p>В этом разделе собрана литература по городской археологии и истории Санкт-Петербурга. Здесь вы найдете источники, которые нам удалось собрать. Для источников, доступных в интернете, имеется ссылка для перехода (знак лупы).</p>
            <p>Перед использованием изучите инструкцию по исполбзованию данного <Link to="/how-to-use" className="link">раздела</Link>.</p>
