    ...
    <div className="about-project-container">
      <div className="about-project-center-col">
        ...
        <div className='about-project-introductory-text-section'>
          ...
          <p>
            В этом разделе мы кратко расскажем о структуре и целях проекта, поделимся планами на будущее.
          </p>
          <p>
              Мы надеемся, что представленный ресурс будет полезен как специалистам в области истории 
